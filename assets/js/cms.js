...
const DEFAULT_DATA = {
  ...
  faculty: [
    { id: 1,  name: 'โชติวิทย์ ธรรมสุจิตร',              role: 'director', dept: 'ผู้อำนวยการโรงเรียนสาธิตมหาวิทยาลัยศรีนครินทรวิโรฒ ปทุมวัน', subject: '', tag: 'Director',     email: 'director@pds.ac.th', photo: 'assets/img/director-chotiwit.png' },
    { id: 2,  name: 'นายสุนทร ภูรีปรีชาเลิศ',             role: 'deputy',   dept: 'รองผู้อำนวยการฝ่ายวิชาการวิจัย และพันธกิจสัมพันธ์เพื่อสังคม',  subject: '', tag: 'Deputy',       email: 'deputy@pds.ac.th',   photo: 'assets/img/deputy-suntorn.png' },
    { id: 3,  name: 'อาจารย์ปรเมษฐ์ คำจร',               role: 'head',     dept: 'หัวหน้ากลุ่มสาระการเรียนรู้เทคโนโลยี',                          subject: '', tag: 'Head',         email: 'head@pds.ac.th',     photo: 'assets/img/head-parames.png' },
    { id: 4,  name: 'อาจารย์กิตติศักดิ์ นิทาน',            role: 'teacher',  dept: 'กลุ่มงานคอมพิวเตอร์',    subject: 'วิชาเทคโนโลยีสารสนเทศ',      tag: 'Computer',     email: 'teacher@pds.ac.th',  photo: 'assets/img/teacher-kittisak.png' },
    { id: 5,  name: 'อาจารย์เสกสรรค์ หงษ์หิรัญพันธ์',      role: 'teacher',  dept: 'กลุ่มงานธุรกิจ',        subject: 'วิชาการงานอาชีพ',              tag: 'Business',     email: 'teacher@pds.ac.th',  photo: 'assets/img/teacher-seksun.png' },
    { id: 6,  name: 'อาจารย์ณภัสวรรก์ สุภาแสน',           role: 'teacher',  dept: 'กลุ่มงานคหกรรม',        subject: 'วิชาการดำรงชีวิต',             tag: 'Home Ec.',     email: 'teacher@pds.ac.th',  photo: 'assets/img/teacher-naphaswan.png' },
    { id: 7,  name: 'อาจารย์กรวิชญ์ โสภา',               role: 'teacher',  dept: 'กลุ่มงานช่างและออกแบบ', subject: 'วิชางานช่างและออกแบบ',          tag: 'Design',       email: 'teacher@pds.ac.th',  photo: 'assets/img/teacher-kornvich.png' },
    { id: 8,  name: 'อาจารย์ดิเรก พรหมสาขา ณ สกลนคร',    role: 'teacher',  dept: 'กลุ่มงานคอมพิวเตอร์',    subject: 'วิชาการออกแบบและสื่อ',         tag: 'Digital Media', email: 'teacher@pds.ac.th', photo: 'assets/img/teacher-direk.png' },
    { id: 9,  name: 'อาจารย์ปริยากร พรสุทธิพันธุ์',         role: 'teacher',  dept: 'กลุ่มงานธุรกิจ',        subject: 'วิชาพาณิชยกรรม',               tag: 'Business',     email: 'teacher@pds.ac.th',  photo: 'assets/img/teacher-pariyakorn.png' },
    { id: 10, name: 'อาจารย์กิตติญา กูลดี',               role: 'teacher',  dept: 'กลุ่มงานคอมพิวเตอร์',    subject: 'วิชาปัญญาประดิษฐ์และหุ่นยนต์', tag: 'AI & Robotics', email: 'teacher@pds.ac.th', photo: 'assets/img/teacher-kittiya.png' }
  ],
  curriculum: [
    ...
    { id: 38, grade: 4, type: 'major',code: 'ว31294', name: 'คณิตศาสตร์สำหรับคอมพิวเตอร์', name_en: 'Mathematics for Computing',                       teacher: 'อ.ดิเรก',                sem: 'เทอม 2',     track: 'ai', image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=400&q=80&fit=crop', pending: false  },
    ...
    { id: 57, grade: 5, type: 'major',code: 'ว32295', name: 'การโปรแกรมและปัญญาประดิษฐ์', name_en: 'Programming & Artificial Intelligence',                        teacher: 'อ.กิตติญา',               sem: 'เทอม 1',     track: 'ai', image: 'https://images.unsplash.com/photo-1517433456452-88d67391b0d8?w=400&q=80&fit=crop', pending: false },
